                                                               ...
                                                               END) * 4 ) + ( Count(CASE
                                                                                    ...
                                                                                    END) * 3 ) + ( Count(CASE
                                                                                                         ...
                                                                                                         END) * 2 ) + ( Count(CASE
                                                                                                                              ...
                                                                                                                              END) * 1 ) + ( Count(CASE
                                                                                                                                                     WHEN BHISTRESPPROVA.CODRESPOSTA = 'F' THEN 1
                                                                                                                                                   END) * 0.5 ) ) / ( Count( CASE WHEN ( BHISTORICO.CODPESSOA IS NULL ) THEN 1 END) + Count (CASE WHEN ( BHISTORICO.CODPESSOA IS NOT NULL ) THEN 1 END ) ) ), 2) ) * 100 ) / 5 ) <= 89 THEN 4
         WHEN (( ( ( Round(( ( ( Count(CASE
                                         WHEN BHISTRESPPROVA.CODRESPOSTA = 'A' THEN 1
                                       END) * 5 ) + ( Count(CASE
                                                              WHEN BHISTRESPPROVA.CODRESPOSTA = 'B' THEN 4
                                                               ...
                                                               END) * 4 ) + ( Count(CASE
                                                                                    ...
                                                                                    END) * 3 ) + ( Count(CASE
                                                                                                         ...
                                                                                                         END) * 2 ) + ( Count(CASE
                                                                                                                              ...
                                                                                                                              END) * 1 ) + ( Count(CASE
                                                                                                                                                     WHEN BHISTRESPPROVA.CODRESPOSTA = 'F' THEN 1
                                                                                                                                                   END) * 0.5 ) ) / ( Count( CASE WHEN ( BHISTORICO.CODPESSOA IS NULL ) THEN 1 END) + Count (CASE WHEN ( BHISTORICO.CODPESSOA IS NOT NULL ) THEN 1 END ) ) ), 2) ) * 100 ) / 5 ) <= 69 THEN 3
         WHEN (( ( ( Round(( ( ( Count(CASE
                                         WHEN BHISTRESPPROVA.CODRESPOSTA = 'A' THEN 1
                                       END) * 5 ) + ( Count(CASE
                                                              WHEN BHISTRESPPROVA.CODRESPOSTA = 'B' THEN 4
                                                               ...
                                                               END) * 4 ) + ( Count(CASE
                                                                                    ...
                                                                                    END) * 3 ) + ( Count(CASE
                                                                                                         ...
                                                                                                         END) * 2 ) + ( Count(CASE
                                                                                                                              ...
                                                                                                                              END) * 1 ) + ( Count(CASE
                                                                                                                                                     WHEN BHISTRESPPROVA.CODRESPOSTA = 'F' THEN 1
                                                                                                                                                   END) * 0.5 ) ) / ( Count( CASE WHEN ( BHISTORICO.CODPESSOA IS NULL ) THEN 1 END) + Count (CASE WHEN ( BHISTORICO.CODPESSOA IS NOT NULL ) THEN 1 END ) ) ), 2) ) * 100 ) / 5 ) <= 49 THEN 2
         WHEN (( ( ( Round(( ( ( Count(CASE
                                         WHEN BHISTRESPPROVA.CODRESPOSTA = 'A' THEN 1
                                       END) * 5 ) + ( Count(CASE
                                                              WHEN BHISTRESPPROVA.CODRESPOSTA = 'B' THEN 4
